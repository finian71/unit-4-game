$(document).ready(function() {
  ...
  function selectCharacter(characterHP, characterName, ap) {
    $('#darthVader, #empPalpatine, #kenobi, #yoda').on('click', function(event) {
      ...
      $('#character').html(
        ...
        }<br><img class='img-thumbnail' src="assets/images/Characters/${chosenCharacter}.jpg" alt=""><br><p id="${chosenCharacter}Value">${
      ...
      enemies.forEach(enemy => {
        ...
        $('#enemies').append(
          `<div class="w-25 p-3" id=${enemy}> ${
            characterName[enemy]
          }<br><img class='img-thumbnail' src="assets/images/Characters/${enemy}.jpg" alt=""><br> <p id="${enemy}Value">${
            characterHP[enemy]
          }</p></div>`
        );
        $(`#${enemy}`).css({
